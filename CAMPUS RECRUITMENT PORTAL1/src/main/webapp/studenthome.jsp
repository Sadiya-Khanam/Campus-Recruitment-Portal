...
.content{
	...
	width: 100%;
	height:680px;
	background: linear-gradient(60deg, rgba(158, 189, 19, 0.2), rgba(0, 133, 82, 0.2)), url('images/jspmbg2.jpg') center no-repeat;
...
<div class="content">
	...
	<h2>JSPM'S Jayawant Institute of Management Studies</h2>
	<h3>80, E Building, JSPM Campus, Mumbai Pune Bypass Rd, Ashok Nagar, Tathawade, Pimpri-Chinchwad, Maharashtra 411033</h3>
</div>
</body>
</html>