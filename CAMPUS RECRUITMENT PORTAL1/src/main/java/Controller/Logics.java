...
public class Logics extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("viewDrives")!=null)
		{
			...
			if(branch==null) {
				Students student = Dao.getStudent(usn);
				branch = student.getDept_name();
			}
		...
		if(request.getParameter("apply")!=null)
		{
			...
			try {
				...
				String newusn=new String(usnPart).trim();
				String application_id= "j:" + jid+ "a:" + newusn;
		...
		if(request.getParameter("rejectApplication")!=null)
		{
			...
			if(Dao.deleteDriveApplication(applicationId))
			{
				...
				int startIndex = applicationId.indexOf(":") + 1;
				int endIndex = applicationId.indexOf("a:") - 1;
				String jobid = applicationId.substring(startIndex, endIndex);
